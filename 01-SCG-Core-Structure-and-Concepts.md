...
<img src="./imgs/scg-how-it-works.png" width="80%">

### Route

<img src="./imgs/route-find-request.png" width="80%">

- Gateway 관점에서 Route는 하나의 작업단위이다.

<img src="./imgs/route-detail.png" width="80%">
...
<img src="./imgs/route-predicate.png" width="80%">
...
<img src="./imgs/route-predicate-true.png" width="80%">

- Gateway는 설정된 모든 Predicate가 True를 반환할 때만 해당 Route가 유효하다고 판단한다.

<img src="./imgs/route-predicate-false.png" width="80%">
...
<img src="./imgs/filter-2.png" width="80%">
